...
for i in range(len(a)):
    n = [0,0,0,0,0]
    n[0] = 'PlateExtractedDNA'
    n[1] = source_well[i]
    n[2] = 'PlateGibsonAssembly'
...
with open('ECHO_GibsonAssembly.csv', 'w', newline='') as g:
	...
	extracted_DNA.writerow(["Source Plate Name", "Source Well", "Destination Plate Name", "Destination Well", "Transfer Volume"])
