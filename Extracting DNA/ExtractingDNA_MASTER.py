...
#	|                          |  6
#	|--------------------------|
#	|      Elution Buffer      |  5     Add this after completing Part (4/6)
#	|--------------------------|
#	|                          |  4
#	|--------------------------|
#	|         Ethanol          |  3     Add this after completing Part (1/6)
#	|--------------------------|
#	|                          |  2
#	|--------------------------|
...
#   |               |               |               |               |               |
#   |               |               |               |               |               |
#   | tiprack-200ul | tiprack-200ul |384 well plate |               |               |  1
#   |               |               |               |               |               |
#   |               |               |               |               |               |
#   |_______________________________________________________________________________|
...
print('There are 6 parts to DNA Extraction Protocol')
exec(open('ExtractingDNA1.py').read())
print('Part (1/6) of DNA Extraction is completed.')
...
print('Part (5/6) of DNA Extraction is completed.')
